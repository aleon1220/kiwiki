...
- [Security and chryptography](#security-and-chryptography)
  ...
  - [- Old 2009 tool java based UI keytool-iui but still relevant. Link to old google code](#--old-2009-tool-java-based-ui-keytool-iui-but-still-relevant-link-to-old-google-code)
    - [Analyze and Check artifacts generated by `OpenSSL`](#analyze-and-check-artifacts-generated-by-openssl)
      ...
      - [metadata of certificate and key](#metadata-of-certificate-and-key)
      - [Convert a private from traditional to PKCS#5 v2.0 format using triple DES:](#convert-a-private-from-traditional-to-pkcs5-v20-format-using-triple-des)
      ...
      - [Convert a private key from any PKCS#8 format to traditional format:](#convert-a-private-key-from-any-pkcs8-format-to-traditional-format)
      - [Obtain certificate from a domain and reate a `.pem`](#obtain-certificate-from-a-domain-and-reate-a-pem)
      - [Add a set of certificates to a linux OS Key store](#add-a-set-of-certificates-to-a-linux-os-key-store)
    - [TLS validations](#tls-validations)
    - [Check if SSL V2 or V3 is accepted on URL](#check-if-ssl-v2-or-v3-is-accepted-on-url)
      - [To check SSL V2](#to-check-ssl-v2)
      - [To Check SSL V3](#to-check-ssl-v3)
      - [To Check TLS 1.0](#to-check-tls-10)
      - [To Check TLS 1.1](#to-check-tls-11)
      - [To Check TLS 1.2](#to-check-tls-12)
